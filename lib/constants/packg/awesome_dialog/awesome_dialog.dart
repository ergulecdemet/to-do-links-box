...
import 'package:my_links/constants/packg/awesome_dialog/src/vertical_stack_header_dialog.dart';
...
class AwesomeDialog {
  ...
  Widget get _buildFancyButtonOk => AnimatedButton(
        ...
        text: btnOkText ?? 'Evet',
        color: btnOkColor ?? appColors!.primaryColor,
        icon: btnOkIcon,
  ...
  Widget get _buildFancyButtonCancel => AnimatedButton(
        ...
        text: btnCancelText ?? 'Vazgeç',
        color: btnCancelColor ?? appColors!.redColor,
        icon: btnCancelIcon,
        borderRadius: buttonsBorderRadius,
        buttonTextStyle: buttonsTextStyle,
      );
